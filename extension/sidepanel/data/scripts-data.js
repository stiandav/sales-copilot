...
// Each entry has a short `response` (max ~12 words) for live mode one-liner display
const QUICK_TAPS = {
  "": [
    { label: "Not Interested", text: "We're not interested in selling right now", response: "Totally fair — what if you just knew your home's value?" },
    { label: "Has Agent", text: "We already have an agent we're working with", response: "Smart — are you under a signed agreement right now?" },
    { label: "Relist Same Agent", text: "We're relisting with the same agent", response: "Before you sign, wouldn't a second pricing opinion help?" },
    { label: "Going to Wait", text: "We're going to wait and see what happens", response: "Makes sense — want to know your number so you're ready?" },
    { label: "Already Chose", text: "We already chose someone else", response: "Got it — have you signed the listing agreement yet?" },
    { label: "Send Something", text: "Can you just send me something in the mail or email", response: "Absolutely — what's the best email for your home report?" },
    { label: "Bad Timing", text: "This isn't a good time, I'm busy right now", response: "No problem — morning or afternoon better tomorrow?" },
    { label: "Not Selling", text: "We love our home, we're not planning to move at all", response: "Love that — would you want to know what it's worth though?" },
    { label: "Price / Fees", text: "I don't want to pay agent commission fees, too expensive", response: "I hear you — what if you netted more even after commission?" },
    { label: "Need Spouse", text: "I need to talk to my wife or husband about this first", response: "Of course — can I call when you're both available?" },
    { label: "Market Concern", text: "I think the market is down right now, prices are dropping", response: "Actually your area is still strong — want the real numbers?" },
    { label: "Bad Experience", text: "We had a bad experience with our last agent, it didn't sell", response: "That's frustrating — want to see what went wrong specifically?" },
    { label: "DIY / FSBO", text: "We want to sell it ourselves, don't need an agent", response: "Respect that — what if I showed you the net difference?" },
    { label: "Financial", text: "We're struggling with payments and things are tight right now", response: "You likely have more equity than you think — want to check?" },
    { label: "Do Not Call", text: "Please take me off your list, don't call me again", response: "Removing you now — sorry for the bother, have a great day." },
  ],
  expired: [
    { label: "Tried Before", text: "We already tried selling and it sat on the market for months", response: "Market's shifted since then — want to see today's numbers?" },
    { label: "Agent Failed", text: "Our last agent couldn't sell it, I doubt you can either", response: "Totally get that — can I show you what we'd do differently?" },
    { label: "Bad Experience", text: "We had a bad experience listing, not doing that again", response: "That's frustrating — want to see what actually went wrong?" },
    { label: "No Offers", text: "It was on the market with no offers, total waste of time", response: "Usually it's price, condition, or marketing — want a quick look?" },
    { label: "Not Relisting", text: "We're not interested in listing again, it didn't work", response: "Fair enough — what if the issue was just the strategy?" },
    { label: "Relist Same Agent", text: "We're relisting with the same agent we used before", response: "Before you sign, wouldn't a second pricing opinion help?" },
    { label: "Going to Wait", text: "We're going to wait before trying to list again", response: "Makes sense — want to know your number so you're ready?" },
    { label: "Already Chose", text: "We already chose another agent to relist with", response: "Got it — have you signed the listing agreement yet?" },
    { label: "Send Something", text: "Just send me some info about your services", response: "Absolutely — what's the best email for your home report?" },
    { label: "Overpriced", text: "Agents always overpromise on price to get the listing", response: "You're right to be skeptical — want real comps, no fluff?" },
    { label: "Has Agent", text: "We're already talking to another agent about relisting", response: "Smart to interview — are you under a signed agreement?" },
    { label: "Not Interested", text: "Not interested, we took it off the market on purpose", response: "Understood — would just knowing the current value help?" },
    { label: "Need Spouse", text: "I need to talk to my spouse before we consider relisting", response: "Of course — can I call when you're both available?" },
    { label: "Bad Timing", text: "This isn't a good time, maybe in the spring", response: "No problem — morning or afternoon better tomorrow?" },
    { label: "Do Not Call", text: "Please stop calling about our expired listing", response: "Removing you now — sorry for the bother, have a great day." },
  ],
  fsbo: [
    { label: "Commission", text: "I don't want to pay six percent commission to an agent", response: "I hear you — what if you netted more even after commission?" },
    { label: "Sell Myself", text: "We're going to try selling it ourselves to save money", response: "Respect that — what if I showed you the net difference?" },
    { label: "No Agent Needed", text: "We don't need an agent, we can handle this ourselves", response: "You might be right — want to compare the numbers though?" },
    { label: "Already Chose", text: "We already chose an agent if we decide to use one", response: "Got it — have you signed the listing agreement yet?" },
    { label: "Send Something", text: "Just send me your info, I'll call if I need help", response: "Absolutely — what's the best email for your market report?" },
    { label: "Going to Wait", text: "We're going to wait and see if it sells on our own first", response: "Makes sense — want to know the agent-listed price difference?" },
    { label: "Have Buyers", text: "We already have interested buyers looking at our home", response: "That's great — are any of them pre-approved with a lender?" },
    { label: "Fees Too High", text: "Agent fees are way too high, not worth it", response: "I get it — want to see the actual net-to-you comparison?" },
    { label: "Zillow/Redfin", text: "We're just going to list it on Zillow ourselves", response: "Smart move — want to see how MLS exposure compares?" },
    { label: "Not Interested", text: "Not interested in hiring an agent right now", response: "No pressure — want a free comp report for your pricing?" },
    { label: "Need Spouse", text: "I need to talk to my husband or wife about using an agent", response: "Of course — can I call when you're both available?" },
    { label: "Do Not Call", text: "Please don't call me about listing with an agent", response: "Removing you now — sorry for the bother, have a great day." },
  ],
  frbo: [
    { label: "Just Renting", text: "We're just renting it out, not looking to sell", response: "Totally understand — do you know how much equity you're sitting on?" },
    { label: "Tenant Issues", text: "I'm tired of dealing with tenants and property management", response: "A lot of landlords feel that — want to see your equity options?" },
    { label: "Good Investment", text: "It's a good investment property, I'm keeping it", response: "Smart — have you seen what it's actually worth right now?" },
    { label: "Going to Wait", text: "We're going to wait before making any moves with the rental", response: "Makes sense — want to know your number so you're ready?" },
    { label: "Already Chose", text: "We already have an agent picked out when we're ready", response: "Got it — have you signed any agreement with them?" },
    { label: "Send Something", text: "Just send me some info about selling rental properties", response: "Absolutely — what's the best email for your equity report?" },
    { label: "Rental Income", text: "The rental income is good, no reason to sell", response: "That's great — but have you compared it to the equity gains?" },
    { label: "Not the Time", text: "It's not the right time to sell a rental property", response: "Fair enough — want to know your number for when it is?" },
    { label: "Has Agent", text: "I already have an agent for when I decide to sell", response: "Smart to have someone — are you under a signed agreement?" },
    { label: "1031 Exchange", text: "If I sell I'd need a 1031 exchange and that's complicated", response: "We handle those all the time — want a quick walkthrough?" },
    { label: "Need Spouse", text: "I need to discuss selling the rental with my spouse", response: "Of course — can I call when you're both available?" },
    { label: "Do Not Call", text: "Please don't call me about selling my rental", response: "Removing you now — sorry for the bother, have a great day." },
  ],
  "pre-foreclosure": [
    { label: "Working w/ Bank", text: "We're working it out with the bank, don't need help", response: "Glad to hear — do you know your home's current equity position?" },
    { label: "Not That Bad", text: "It's not that bad yet, we're catching up on payments", response: "Good — knowing your equity gives you options either way." },
    { label: "Don't Want Sell", text: "We don't want to sell our home, we'll figure it out", response: "I respect that — want to just know your options confidentially?" },
    { label: "Going to Wait", text: "We're going to wait and see if we can work it out", response: "Understand — knowing your equity protects you no matter what." },
    { label: "Already Chose", text: "We already chose someone to help us with this", response: "Good — are they a licensed real estate specialist in this?" },
    { label: "Send Something", text: "Can you send me some information about our options", response: "Absolutely — what's the best email for your confidential report?" },
    { label: "Embarrassed", text: "I don't really want to talk about our financial situation", response: "Completely confidential — you likely have more equity than you think." },
    { label: "Have Attorney", text: "We already have an attorney helping us with this", response: "Smart — has your attorney shown you the equity numbers?" },
    { label: "Short Sale", text: "We owe more than it's worth, a short sale won't help us", response: "Values have jumped — you might have more equity than you think." },
    { label: "Need Time", text: "We just need more time, things will get better", response: "Hope so — knowing your options now gives you more leverage." },
    { label: "Scam Concern", text: "How do I know this isn't a scam, people keep calling us", response: "Valid concern — I'm a licensed local agent, happy to verify." },
    { label: "Need Spouse", text: "I need to talk to my spouse before making any decisions", response: "Of course — can I call when you're both available?" },
    { label: "Do Not Call", text: "Please stop calling us about our mortgage situation", response: "Removing you now — sorry for the bother, have a great day." },
  ],
};
